...
- **First-class settings.** Configurable from the sidebar *Plugins → dsh-ui-outline* in dsh ≥ 0.1.6 (or *Settings → Plugins* in dsh ≤ 0.1.5), persisted in the host's settings document — preferences follow you across browsers and machines. Not localStorage.
